                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<ul class="product-links">
								<li>Share:</li>
								<li>
									<a href="https://www.facebook.com/hyuezh01"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/HunhcHu62260658"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/hdh.huyyyy"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://github.com/huynhuchuy2001"><i class="fa fa-github"></i></a>
								</li>
							</ul>
